...
REM ogr2ogr --config OGR_SQLITE_PRAGMA = "foreign_keys=on,cache_size=500000" %GLDBPRODSKIPF% -append -f SQLite .\dbinteg\GRACETHD_integ.sqlite .\shpcsv-in\t_adresse.shp -nln t_adresse
REM ogr2ogr %GLDBPRODSKIPF% -append .\dbinteg\GRACETHD_integ.sqlite .\shpcsv-in\t_organisme.csv -nln t_organisme
...
ECHO GRACETHD - INSERT %GLFILE%
IF EXIST "%GLFILE%" "%GLOGR2OGR%" %GLDBPRODSKIPF% -append %GLDB% "%GLFILE%" -nln %GLTBL%
%GLPAUSE%
...
SET GLFILE=%GLSHPINPATH%\%GLTBL%.shp
ECHO GRACETHD - INSERT %GLFILE%
IF EXIST "%GLFILE%" "%GLOGR2OGR%" %GLDBPRODSKIPF% -append %GLDB% "%GLFILE%" -nln %GLTBL% -nlt PROMOTE_TO_MULTI
%GLPAUSE%
