...
INSERT INTO l_bp_racco VALUES ('FIMP18', 'TRAITEMENT IMPOSSIBLE : PTO EXISTANTE', 'Lorsqu une commande a ete passee sans PTO (construction de ligne), qu il s avere qu elle existait le logement et que le problème n a pas pu etre resolu par un reprovisionning a chaud. La reference de la PTO doit alors être indiquee... (cf Interop)');
